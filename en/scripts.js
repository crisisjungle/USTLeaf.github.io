    ...
    */
    ...
    if (isGalleryPage) {
        ...
        if (countParagraph) {
            ...
            let textFormat = `Check {s} types of plants on campus, {p} plant pictures`;
            ...
            animateCounter(numSpecies, duration, (currentValue) => {
                ...
                const photoCountMatch = currentText.match(/，(\d+) plant pictures/);
            ...
            animateCounter(numPhotos, duration, (currentValue) => {
                const currentText = countParagraph.textContent;
                const speciesCountMatch = currentText.match(/Check (\d+) types/);
        ...
        function displayPhotos(photosToDisplay) {
            ...
            photosToDisplay.forEach(photo => {
                ...
                const categoryText = categoryClass; // 获取英文标签
        ...
        if (galleryGrid && filterButtonsContainer) {
            ...
            heroCategoryCards.forEach(card => {
                ...
                if (cardTitle.includes('Tree')) filterValue = 'tree';
                else if (cardTitle.includes('Flower')) filterValue = 'flower';
                else if (cardTitle.includes('Leaf')) filterValue = 'leaf';
                else if (cardTitle.includes('Fruit')) filterValue = 'fruit';
